...
const EditArtwork: React.FC<EditArtworkProps> = ({selectedArtwork, onClose}) => {
...
return <Action onClick={() => {handleRemove(selectedArtwork.id)}}><FontAwesomeIcon icon={faTrash} /> Remove artwork</Action>
}
